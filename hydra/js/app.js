(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-section__slider")) new core(".main-section__slider", {
            modules: [ Navigation, Controller, Grid ],
            observer: true,
            observeParents: true,
            spaceBetween: 40,
            autoHeight: true,
        ...
        if (document.querySelector(".services__slider")) new core(".services__slider", {
            ...
            fill: "column",
            navigation: {
                prevEl: ".services__slider-arrow.swiper-button-prev",
                nextEl: ".services__slider-arrow.swiper-button-next"
            },
            breakpoints: {
                290: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".technologies__slider")) new core(".technologies__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".slider-technologies__button.swiper-button-prev",
                nextEl: ".slider-technologies__button.swiper-button-next"
            },
            breakpoints: {
                290: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".content-build__slider")) new core(".content-build__slider", {
            modules: [ Navigation, Controller ],
            observer: true,
            observeParents: true,
            autoHeight: false,
            speed: 800,
            navigation: {
                prevEl: ".content-build__button.swiper-button-prev",
                nextEl: ".content-build__button.swiper-button-next"
            },
            breakpoints: {
                290: {
                    slidesPerView: 1,
    ...
    for (const title of titleContainer) {
        const spanTitle = document.createElement("span");
        if (title) {
            const titleValue = title.querySelector(".title__value");
            if (titleValue) titleValue.append(spanTitle);
        }
    }
    window.onload = function() {
        ...
        function documentAction(e) {
            ...
            if (targetElement.closest("[data-go]")) {
                const targetAtr = targetElement.closest("[data-go]").dataset.go;
                const goToElement = document.querySelector(targetAtr);
                ...
                if (goToElement) window.scrollTo({
                    top: goToElement.offsetTop - (headerHeight + 100),
                    behavior: "smooth"
                });
            }
            e.preventDefault();
    ...
    const script_form = document.querySelector(".join-hydra__form");
    const inputsRequired = script_form.querySelectorAll(".input");
    script_form.addEventListener("submit", getInp);
    function getInp(event) {
        inputsRequired.forEach((input => {
            if (input.hasAttribute("data-required")) {
                const textAtribute = input.getAttribute("data-error");
                console.log(input);
                input.insertAdjacentHTML("afterend", `<div class="input-error">\n\t\t\t\t\t${textAtribute}\n\t\t\t\t</div>\n\t\t\t\t`);
            }
        }));
